          ...
          <div class="working-process-content-wrap">
            <div class="working-col">
              ...
              <div class="working-process-item">
                ...
                <div class="content">
                  <h4 class="title"><a href="registration.php">Create an Account</h4></a>
                  <p class="desc">Create your account and start your Journey</p>
                </div>
            ...
            <div class="working-col">
              ...
              <div class="working-process-item">
                ...
                <div class="content">
                  <h4 class="title"><a href="job-apply.php">CV/Resume</h4></a>
                  <p class="desc">Create a professional CV that highlights your skills and attracts top employers easily.</p>
                </div>
                <div class="shape-arrow-icon">
                  <img class="shape-icon" src="assets/img/icons/right-arrow.png" alt="Image-HasTech">
                  <img class="shape-icon-hover" src="assets/img/icons/right-arrow2.png" alt="Image-HasTech">
            ...
            <div class="working-col">
              ...
              <div class="working-process-item">
                ...
                <div class="content">
                  <h4 class="title"><a href="job.php">Find Your Job</h4></a>
                  <p class="desc">Find your dream job faster with smart search and personalized career matches.</p>
                </div>
                <div class="shape-arrow-icon">
                  <img class="shape-icon" src="assets/img/icons/right-arrow.png" alt="Image-HasTech">
                  <img class="shape-icon-hover" src="assets/img/icons/right-arrow2.png" alt="Image-HasTech">
            ...
            <div class="working-col">
              ...
              <div class="working-process-item">
                ...
                <div class="content">
                  <h4 class="title"><a href="job-apply.php">Save & Apply</h4></a>
                  <p class="desc">Save preferred jobs, apply instantly, and track your application progress with ease.</p>
                </div>
